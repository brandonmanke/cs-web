...
- **Weapons (chosen, CC0):** [Modern Weapons PS1 Style](https://ace-spectre.itch.io/modern-weapons-ps1-style) and [PS1 Heavy and Light Weapons Pack](https://ace-spectre.itch.io/ps1-heavy-and-light-weapons-pack) (ace-spectre, CC0; textures from texturer.com under its own terms — check before shipping; one reported missing pistol texture) + [Low Poly Glock](https://mextie.itch.io/low-poly-glock) (mextie, CC0, ships a GLB directly). These are optional art upgrades after the M3 mechanics gate. M3 may ship original code-built low-poly viewmodels so licensing/download work cannot block the demo.
